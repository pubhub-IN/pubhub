        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">About this course</h2>
            ...
            {/* Course curriculum */}
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Course Curriculum</h2>
          ...
          <div className="md:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md sticky top-8">
              <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">Ready to start learning?</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center text-green-600 dark:text-green-400">✓</div>
                  <span className="text-gray-700 dark:text-gray-300">Code examples & projects</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center text-green-600 dark:text-green-400">✓</div>
                ...
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center text-green-600 dark:text-green-400">✓</div>
                  <span className="text-gray-700 dark:text-gray-300">Certificate upon completion</span>
                </div>
              </div>
              
              <div className="mt-6">
                <button
                  onClick={() => navigate(`/courses/${course.id}/${course.modules[0]?.id}/${course.modules[0]?.lessons[0]?.id}`)}
