...
export default function CourseCompletionPage({ user }: CourseCompletionPageProps) {
  ...
  const completionPercentage = courseId ? 
    getCourseCompletionPercentage(user, courseId, totalLessons) : 0;
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-3xl mx-auto px-4">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
          {/* Header */}
          <div className={`p-8 text-center text-white ${canComplete 
            ...
            {canComplete ? (
              ...
              <>
                ...
                <p className="text-amber-100 mb-4">
                  You've made progress on the {course.title} course, but need to complete at least 80% to earn your certificate.
                </p>
              </>
            )}
            ...
            <div className="flex justify-center gap-4">
              <div className="flex items-center gap-2">
                <CheckCircle className={`w-5 h-5 ${canComplete ? 'text-green-300' : 'text-amber-300'}`} />
                <span>{completionPercentage}% Complete</span>
              </div>
              <div className="flex items-center gap-2">
                <BarChart className={`w-5 h-5 ${canComplete ? 'text-green-300' : 'text-amber-300'}`} />
          ...
          {canComplete ? (
            ...
            <div className="p-8 border-b border-gray-200 dark:border-gray-700">
              <div className="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-6 text-center">
                <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-gray-100 mb-1">Certificate of Completion</h2>
                <p className="text-gray-500 dark:text-gray-400 mb-6">This certifies that</p>
                <p className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">{user.name || user.github_username}</p>
                <p className="text-gray-500 dark:text-gray-400 mb-4">has successfully completed the course</p>
                <p className="text-xl font-bold text-green-600 dark:text-green-400 mb-6">{course.title}</p>
                <p className="text-gray-500 dark:text-gray-400 mb-1">on {formattedDate}</p>
                <div className="w-24 h-1 bg-green-600 mx-auto my-4"></div>
                <p className="text-gray-800 dark:text-gray-200 font-semibold">PubHub Learning</p>
              </div>
            ...
            <div className="p-8 border-b border-gray-200 dark:border-gray-700">
              <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-6">
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Complete More Lessons</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  You need to complete at least 80% of the lessons to earn your certificate. 
                  You've currently completed {completionPercentage}%.
                </p>
                <div className="w-full bg-gray-200 dark:bg-gray-700 h-3 rounded-full overflow-hidden mb-4">
                  <div 
                    className={`h-full rounded-full ${completionPercentage >= 80 ? 'bg-green-500' : 'bg-amber-500'}`}
          ...
          {/* Next steps */}
          <div className="p-8">
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">What's Next?</h2>
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-1">Explore More Courses</h3>
